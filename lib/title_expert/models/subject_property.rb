...
module TitleExpert
  ...
  class SubjectProperty
    # The title number for the property matched.
    attr_accessor :title_number

    # Contains the address details for the property matched.
    attr_accessor :property_address

    # Tenure of the property matched.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PropertyAddress')
        self.property_address = attributes[:'PropertyAddress']
      end
    ...
    def hash
      [title_number, property_address, tenure].hash
    end
