...
module TitleExpert
  # Contains details of an errors associated with an identified item
  class ErrorItemDetails
    # The identifier of the item with an error
    attr_accessor :item

    # The details of the error for the identified item
