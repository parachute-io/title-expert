...
module TitleExpert
  # The specification of a Title Data request to be issued.
  class TitleDataRequest
    ...
    # Whether or not a Title Plan is to be requested from the LR in addition to rthe OC. May be omitted, in which case a plan is not requested.
    ...
    def hash
      [client_parameters, deadline, no_aggregated_issues, title_number, with_plan].hash
    end
