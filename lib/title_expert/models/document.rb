...
module TitleExpert
  # The data extracted from a single RES Q1DocumentEntry element, describing a document referred to on the register.
  class Document
    # The document type.
    ...
    # An array of the letter and entry number within the relevant Sub-Register or Schedule. There will always be at least one element.
    attr_accessor :entry_numbers

    # Whether the document is only held as a plan.
    attr_accessor :plan_only

    # Null unless the document is filed under a different title number, in which case it contains that title number.
    attr_accessor :filed_under

    # The full description of the document as it appears on the register.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EntryNumbers')
        if (value = attributes[:'EntryNumbers']).is_a?(Array)
          self.entry_numbers = value
        end
      end

      if attributes.has_key?(:'PlanOnly')
        self.plan_only = attributes[:'PlanOnly']
      end
    ...
    def list_invalid_properties
      ...
      if @entry_numbers.nil?
        invalid_properties.push("invalid value for 'entry_numbers', entry_numbers cannot be nil.")
      end

      if @plan_only.nil?
        invalid_properties.push("invalid value for 'plan_only', plan_only cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @entry_numbers.nil?
      return false if @plan_only.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          entry_numbers == o.entry_numbers &&
          plan_only == o.plan_only &&
