...
module TitleExpert
  # The response to an address match request
  class AddressMatchResponse
    # The result of an address match
    ...
    def valid?
      ...
      result_validator = EnumAttributeValidator.new('String', ["NoMatch", "Match", "MatchMissingPostcode", "MatchNoPostcodes"])
    ...
    def result=(result)
      validator = EnumAttributeValidator.new('String', ["NoMatch", "Match", "MatchMissingPostcode", "MatchNoPostcodes"])
