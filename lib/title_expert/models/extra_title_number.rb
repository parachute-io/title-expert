...
module TitleExpert
  # Information about an \"extra title number\" found in the OC, and the register entries that refer to it
  class ExtraTitleNumber
    # The title number (non-null and non-empty)
    attr_accessor :title_number

    # 1 or more register entries that refer to the title number
    ...
    def list_invalid_properties
      ...
      if @register_entries.nil?
        invalid_properties.push("invalid value for 'register_entries', register_entries cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @register_entries.nil?
      return true
    end
    ...
    def hash
      [title_number, register_entries].hash
    end
