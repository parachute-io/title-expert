...
module TitleExpert
  # Details of a borrower (typically for a mortgage or re-mortgage)
  class Borrower
    # The borrower's name (the first entry in the array) plus any aliases (e.g. maiden names or names from previous marriages).
    attr_accessor :names
