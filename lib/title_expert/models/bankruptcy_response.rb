...
module TitleExpert
  # Details of a Bankruptcy Request that has been isuued.
  class BankruptcyResponse
    ...
    # Between 1 and 6 names to be checked
    attr_accessor :names
    ...
    def hash
      [client_parameters, response_common, names, alternative_despatch_details, returned_documents].hash
    end
