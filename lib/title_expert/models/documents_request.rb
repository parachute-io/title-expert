...
module TitleExpert
  # The specification of an OC2 (Documents) request to be issued.
  class DocumentsRequest
    # Mandatory. Details of 1 or more documents required.
    ...
    # Mandatory. The title number for which documents are required.
    ...
    def self.swagger_types
      {
        :'required_documents' => :'Array<OC2DocumentSpec>',
        :'client_parameters' => :'ClientParameters',
        :'deadline' => :'DateTime',
        :'title_number' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RequiredDocuments')
        if (value = attributes[:'RequiredDocuments']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @required_documents.nil?
        invalid_properties.push("invalid value for 'required_documents', required_documents cannot be nil.")
      end
    ...
    def valid?
      return false if @required_documents.nil?
    ...
    def hash
      [required_documents, client_parameters, deadline, title_number, property_description, alternative_despatch_details].hash
    end
