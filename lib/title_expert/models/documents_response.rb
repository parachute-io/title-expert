...
module TitleExpert
  # Details of a Docxuments Request that has been isuued.
  class DocumentsResponse
    # Mandatory. Details of 1 or more documents requested.
    attr_accessor :documents_required
    ...
    def self.swagger_types
      {
        :'documents_required' => :'Array<OC2DocumentSpec>',
        :'client_parameters' => :'ClientParameters',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DocumentsRequired')
        if (value = attributes[:'DocumentsRequired']).is_a?(Array)
          self.documents_required = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @documents_required.nil?
        invalid_properties.push("invalid value for 'documents_required', documents_required cannot be nil.")
      end
    ...
    def valid?
      return false if @documents_required.nil?
    ...
    def hash
      [documents_required, client_parameters, response_common, title_number, property_description, alternative_despatch_details, returned_documents].hash
    end
