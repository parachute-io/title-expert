...
module TitleExpert
  ...
  class Q1EntryDetailsType
    ...
    def self.swagger_types
      {
        :'entry_number' => :'TextType',
        :'entry_text' => :'TextType',
        :'registration_date' => :'DateType',
        :'item' => :'Object',
        :'infills' => :'Array<Object>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Infills')
        if (value = attributes[:'Infills']).is_a?(Array)
          self.infills = value
        end
      end
    ...
    def hash
      [entry_number, entry_text, registration_date, item, infills].hash
    end
